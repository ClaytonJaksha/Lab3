...
;-------------------------------------------------------------------------------
;	Chris Coulston and Clayton Jaksha
;	Fall 2014
;	MSP430G2553
;	Draw a box on the Nokia 1202 display everytime that SW3
;	is pressed and released. Use other switches for cursor and
;	box location control.
;-------------------------------------------------------------------------------
